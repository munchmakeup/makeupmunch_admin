...
export function EditArtistForm({ id }: EditArtistFormProps) {
  ...
  useEffect(() => {
    // Simulate API call to fetch artist data
    setTimeout(() => {
      ...
      form.reset({
        ...
        experience: "8",
        price: "25000",
        services: ["bridal", "party", "engagement", "prewedding", "hd", "airbrush"],
        featured: true,
        active: true,
      })
      setIsLoading(false)
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="flex justify-end gap-4">
          <Button variant="outline" type="button" onClick={() => router.push(`/artists/${id}`)}>
            Cancel
          </Button>
